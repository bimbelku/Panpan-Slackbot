/*
*DILARANG RECODE TANPA CREDIT!! SCRIPT INI DI MODIFIKASI ULANG OLEH PANPAN !!REUPLOAD NO CREDIT  = GABAKAL UP SC LAGI!!
*AWAS AE KALO KETAUAN_-
*SUBSCRIBE YOUTUBE KAMI
*Panpan : Panpan Slackbot
...
const vcard = 'BEGIN:VCARD\n' //GANTI NO DAN NAMA DIBAWAH INI JADI PUNYA LU
            ...
            + 'FN:Panpan\n' //PENGEMBANG BY :
            + 'ORG: Pengembang Slackbot;\n' //MYBOT TEAM
            + 'TEL;type=CELL;type=VOICE;waid=6282236929603:+62 822-3692-9603\n' 
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6282236929603@s.whatsapp.net","6282236929603@s.whatsapp.net"] //ganti nomor lu
/************************************/
...
client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Haii Tod  @${num.split('@')[0]}\Selamat datang di group *${mdata.subject}* yang betah ya di sini`
